      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="bg-purple-600 text-white rounded-2xl shadow-lg p-8 flex flex-col justify-between">
              <div>
              ...
              <div className="mt-10">
                <h4 className="font-medium text-white/90 mb-4">Follow Us</h4>
